...
import video1 from "../../image/vm.mp4"
...
const Article=()=>{
    ...
    const GetHight=()=>{
        const gethight=window.scrollY
        if(1300>gethight>1200){
            setnum(16)
        }else if (gethight>1300){
            setnum(24)
        }else{
            setnum(8)
        }
    ...
    useEffect(()=>{
        ...
        return ()=>{
            window.removeEventListener("scroll",GetHight)
        }
    },[])
